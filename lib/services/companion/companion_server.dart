...
const L = {
  en: {
    ...
    hostPresetSunshinePayload: 'Sunshine Payload', hostPresetApolloPayload: 'Jujo.Stream Payload',
    ...
    pairingTitle: 'Server Pairing', pairingDesc: 'Pair with a Jujo.Stream Server host on your network.',
    ...
    pairingPinLabel: 'Enter this PIN on your host', pairingPinHint: 'Open Jujo.Stream Admin and enter the PIN when prompted.',
  ...
  es: {
    ...
    hostPresetSunshinePayload: 'Payload de Sunshine', hostPresetApolloPayload: 'Payload de Jujo.Stream',
    ...
    pairingTitle: 'Emparejamiento de Servidor', pairingDesc: 'Empareja con un host Jujo.Stream Server en tu red.',
    ...
    pairingPinLabel: 'Ingresa este PIN en tu host', pairingPinHint: 'Abre Jujo.Stream Admin e ingresa el PIN cuando se solicite.',
