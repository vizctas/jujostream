  ...
  Widget build(BuildContext context) {
    return Focus(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          title: Text(
            AppLocalizations.of(context).presAppearance,
          ...
          actions: [
            TextButton.icon(
              ...
              label: Text(
                AppLocalizations.of(context).presReset,
        ...
        content: Column(
          ...
          children: List.generate(schemes.length, (i) {
            ...
            return AccessibleAction(
              ...
              selected: sel,
              tooltip: s['label'] as String,
              onActivate: () => Navigator.pop(context, s['id'] as String),
              child: AnimatedContainer(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(
                    color: sel
                        ? context.read<ThemeProvider>().accentLight.withValues(
                            alpha: 0.4,
                          )
                        : Colors.white12,
                    width: 1,
  ...
  Widget build(BuildContext context) {
    ...
    return Focus(
      ...
      child: AnimatedContainer(
        ...
        child: Card(
          color: _editing
              ? context.read<ThemeProvider>().surfaceVariant
              : context.read<ThemeProvider>().surface,
          margin: EdgeInsets.zero,
      ...
      child: AnimatedContainer(
        ...
        decoration: _node.hasFocus
            ? BoxDecoration(
                ...
                border: Border.all(
                  color: context.read<ThemeProvider>().accentLight.withValues(
                    alpha: 0.25,
                  ),
                  width: 1,
                ),
